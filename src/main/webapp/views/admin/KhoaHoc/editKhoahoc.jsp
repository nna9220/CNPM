		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Chỉnh sửa Khóa học</h1>
					<!-- DataTales Example -->
					<div class="card shadow mb-4"
						style="width: 40vw; margin-left: 20vw; margin-right: 20vw;">
						<c:url value="/editKhoahoc" var="edit"></c:url>
									...
									<div class="p-5">
										<form class="user">
											<div class="form-group">
												<label>Khóa học: ${kh.ten_khoahoc }</label> <input readonly
													class="form-control" value="${kh.ma_khoahoc}"
													name="ma_khoahoc" />
											</div>
											<div class="form-group">
												<label>Chương trình đào tạo:</label> <input
													class="form-control" value="${kh.ctdt}" name="ctdt" />
											</div>
