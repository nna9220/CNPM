		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Thêm sinh viên</h1>
										...
										<div class="p-5">
											<form class="user">
												<div class="form-group">
													<label>ID Student:</label> <input
														class="form-control form-control-user"
														placeholder="Nhập mã số sinh viên ..." name="ma_sinhvien">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label>Email:</label> <input
														class="form-control form-control-user"
														placeholder="id@student.hcmute.edu.vn" name="email">
												</div>
												<div class="form-group">
													<label for="khoa">Khóa:</label> <select
														class="custom-select custom-select-sm form-control form-control-sm"
														name="khoa" id="khoa">
														<c:forEach items="${khs}" var="kh" varStatus="STT">
															<option value="${kh.ma_khoahoc}">${kh.ten_khoahoc}</option>
														</c:forEach>
													</select>
												</div>
												<div class="form-group">
