...
@WebServlet(urlPatterns = {"/wait"})
public class RegisterWaitController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			dangkys.registerTopic(sinhvien);
			...
			response.sendRedirect(request.getContextPath() + "/accessful");
		}catch (Exception e) {
			e.printStackTrace();
		}
	}
