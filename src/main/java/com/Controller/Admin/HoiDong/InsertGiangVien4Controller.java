...
@WebServlet(urlPatterns = {"/taohoidong4"})
public class InsertGiangVien4Controller extends HttpServlet {
		...
		try {
			...
			for (FileItem item : items) {
				...
				if (item.getFieldName().equals("ma_giangvien")) {
					hoidong.setGiangvien4(item.getString("UTF-8"));
