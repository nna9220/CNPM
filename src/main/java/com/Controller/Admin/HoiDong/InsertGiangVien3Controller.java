...
@WebServlet(urlPatterns = {"/taohoidong3"})
public class InsertGiangVien3Controller extends HttpServlet {
		...
		try {
			...
			for (FileItem item : items) {
				...
				if (item.getFieldName().equals("ma_giangvien")) {
					hoidong.setGiangvien3(item.getString("UTF-8"));
